import { Sparkles, Globe, Upload, Star, ShoppingCart, Search, ChevronDown, Link2, Package } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6 max-w-[1200px] mx-auto">
      ...
      <div className="bg-gradient-to-r from-[#3b6cf5] to-[#6366f1] rounded-2xl p-5 flex items-center justify-between text-white">
        ...
        <button className="px-5 py-2.5 bg-white text-[#3b6cf5] rounded-xl hover:bg-blue-50 transition-colors shrink-0" style={{ fontSize: '0.85rem', fontWeight: 600 }}>
          소싱 구독 바로가기
        </button>
      </div>

      <InfoBanner message="원클릭 AI 대량 소싱 기능은 Shopee 연동 후 사용 가능합니다. 지금 바로" linkText="연동하기" />

      <PageHeader
        icon={Sparkles}
        title="원클릭 AI 대량 소싱"
        description="소싱 가능 상품 목록에서 상품을 선택하여 대량으로 Shopee에 업로드하세요"
      />
